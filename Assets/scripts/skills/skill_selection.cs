...
public class skill_selection : MonoBehaviour {
	...
	IEnumerator cooldown(float waitTime, classSkills classSkill)
	{
		yield return new WaitForSeconds(waitTime);
	...
	IEnumerator cooldownTimer( float cdtime, classSkills skillEffectsVar, string roleVar, bool weaponSkill ){
	...
	public void CooldownDisplayCheck( float cdtime, List<classSkills> skillEffectsVar, int buttonIDvar ){
