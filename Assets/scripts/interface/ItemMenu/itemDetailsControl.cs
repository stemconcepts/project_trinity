...
public class itemDetailsControl : MonoBehaviour {
	...
	public void DisplayWeaponData( int itemID ){
		//print (itemID);
		var itemName = weaponItemsScript.weaponList[itemID].DisplayName;
		var itemDetails = weaponItemsScript.weaponList[itemID].WeaponDescription;
		var attachedSkills = weaponItemsScript.weaponList[itemID];
		...
		//var skillsTitle = itemSkillHolder.transform.FindChild("Panel").FindChild("skillTextHolder").FindChild("Text-title").GetComponent<Text>();
		//var skillsCost = itemSkillHolder.transform.FindChild("Panel").FindChild("skillTextHolder").FindChild("Text-cost").GetComponent<Text>();
		//var skillsDetail = itemSkillHolder.transform.FindChild("Panel").FindChild("skillTextHolder").FindChild("Text-detail").GetComponent<Text>();
		...
		skillsTitle2.text = attachedSkills.skillTwo.displayName;
	...
	public void DisplaySkillData( int skillID ){
		...
		nameText.text = skillItemsScript.itemList[skillID].displayName;
		previewText.text = skillItemsScript.itemList[skillID].skillDesc;
		skillsCost.text = "Cost: <color=#ff7849>" + skillItemsScript.itemList[skillID].skillCost + "</color>";
	}
	
	// Use this for initialization
	void Awake () {
		weaponItemsScript = menuManager.GetComponent<weaponItems>();
