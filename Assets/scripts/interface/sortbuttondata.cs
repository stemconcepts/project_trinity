...
public class sortbuttondata : MonoBehaviour {
	...
	public List<classSkills> tankSkillClass = new List<classSkills>();
	public List<int> tankSkillIDs = new List<int>();
	public List<int> tankSkillCosts = new List<int>();

	public List<classSkills> healerSkillClass = new List<classSkills>();
	...
	public List<classSkills> dpsSkillClass = new List<classSkills>();
	public List<int> dpsSkillIDs = new List<int>();
	public List<int> dpsSkillCosts = new List<int>();

	public classSkills GetClassSkill( string role ){
		if( role == "Tank" ){
